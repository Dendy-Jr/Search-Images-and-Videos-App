 ...
 */
public abstract class Hilt_ImageDetailFragment<VM extends BaseViewModel> extends BaseFragment<VM> implements GeneratedComponentManagerHolder {
  ...
  Hilt_ImageDetailFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ImageDetailFragment_GeneratedInjector) this.generatedComponent()).injectImageDetailFragment(UnsafeCasts.<ImageDetailFragment>unsafeCast(this));
    }
  }
