 ...
 */
public abstract class Hilt_ImageFilterBottomDialog extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ImageFilterBottomDialog_GeneratedInjector) this.generatedComponent()).injectImageFilterBottomDialog(UnsafeCasts.<ImageFilterBottomDialog>unsafeCast(this));
    }
  }
