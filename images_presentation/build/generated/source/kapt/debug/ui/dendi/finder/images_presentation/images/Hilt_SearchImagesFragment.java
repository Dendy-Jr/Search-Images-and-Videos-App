 ...
 */
public abstract class Hilt_SearchImagesFragment<VM extends BaseViewModel> extends BaseFragment<VM> implements GeneratedComponentManagerHolder {
  ...
  Hilt_SearchImagesFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SearchImagesFragment_GeneratedInjector) this.generatedComponent()).injectSearchImagesFragment(UnsafeCasts.<SearchImagesFragment>unsafeCast(this));
    }
  }
