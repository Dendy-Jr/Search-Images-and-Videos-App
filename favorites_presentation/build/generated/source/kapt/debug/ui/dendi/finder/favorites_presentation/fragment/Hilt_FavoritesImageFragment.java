 ...
 */
public abstract class Hilt_FavoritesImageFragment<VM extends BaseViewModel> extends BaseFragment<VM> implements GeneratedComponentManagerHolder {
  ...
  Hilt_FavoritesImageFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FavoritesImageFragment_GeneratedInjector) this.generatedComponent()).injectFavoritesImageFragment(UnsafeCasts.<FavoritesImageFragment>unsafeCast(this));
    }
  }
