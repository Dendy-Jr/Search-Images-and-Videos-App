 ...
 */
public abstract class Hilt_FavoritesVideoFragment<VM extends BaseViewModel> extends BaseFragment<VM> implements GeneratedComponentManagerHolder {
  ...
  Hilt_FavoritesVideoFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FavoritesVideoFragment_GeneratedInjector) this.generatedComponent()).injectFavoritesVideoFragment(UnsafeCasts.<FavoritesVideoFragment>unsafeCast(this));
    }
  }
