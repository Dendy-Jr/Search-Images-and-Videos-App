 ...
 */
public abstract class Hilt_SearchVideosFragment<VM extends BaseViewModel> extends BaseFragment<VM> implements GeneratedComponentManagerHolder {
  ...
  Hilt_SearchVideosFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SearchVideosFragment_GeneratedInjector) this.generatedComponent()).injectSearchVideosFragment(UnsafeCasts.<SearchVideosFragment>unsafeCast(this));
    }
  }
