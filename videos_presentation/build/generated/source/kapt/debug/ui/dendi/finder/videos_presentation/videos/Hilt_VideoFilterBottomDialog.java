 ...
 */
public abstract class Hilt_VideoFilterBottomDialog extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((VideoFilterBottomDialog_GeneratedInjector) this.generatedComponent()).injectVideoFilterBottomDialog(UnsafeCasts.<VideoFilterBottomDialog>unsafeCast(this));
    }
  }
